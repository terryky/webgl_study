export let pmeter = {};
import {Shader} from "./glutil_shader.js"
...
pmeter.vs_pmeter = `#version 300 es
    in      vec4 a_Vertex;
...
pmeter.fs_pmeter = `#version 300 es
...
{
    pmeter.sobj = Shader.generate_shader (gl, pmeter.vs_pmeter, pmeter.fs_pmeter);
...
pmeter.draw_pmeter_ex = function (gl, dpy_id, x, y, scale)
{
    ...
    gl.bufferData (gl.ARRAY_BUFFER, new Float32Array(vert1), gl.STREAM_DRAW);
    ...
    gl.bufferData (gl.ARRAY_BUFFER, new Float32Array(pmeter.vertex[dpy_id][0]), gl.STREAM_DRAW);
    gl.vertexAttribPointer (pmeter.locVtx, 2, gl.FLOAT, false, 0, 0);
    gl.uniform4f (pmeter.locCol, 1.0, 0.0, 0.0, 1.0);
    gl.drawArrays (gl.LINE_STRIP, 0, pmeter.data_num);
/*
    gl.bufferData (gl.ARRAY_BUFFER, new Float32Array(pmeter.vertex[dpy_id][1]), gl.STREAM_DRAW);
    gl.vertexAttribPointer (pmeter.locVtx, 2, gl.FLOAT, false, 0, 0);
    gl.uniform4f (pmeter.locCol, 0.0, 0.0, 1.0, 1.0);
    gl.drawArrays (gl.LINE_STRIP, 0, pmeter.data_num);

    gl.bufferData (gl.ARRAY_BUFFER, new Float32Array(pmeter.vertex[dpy_id][2]), gl.STREAM_DRAW);
    gl.vertexAttribPointer (pmeter.locVtx, 2, gl.FLOAT, false, 0, 0);
    gl.uniform4f (pmeter.locCol, 1.0, 1.0, 1.0, 1.0);
    gl.drawArrays (gl.LINE_STRIP, 0, pmeter.data_num);

    gl.bufferData (gl.ARRAY_BUFFER, new Float32Array(pmeter.vertex[dpy_id][3]), gl.STREAM_DRAW);
    gl.vertexAttribPointer (pmeter.locVtx, 2, gl.FLOAT, false, 0, 0);
...
*/
    ...
    gl.bindBuffer (gl.ARRAY_BUFFER, pmeter.vbo_vtx);
    gl.bufferData (gl.ARRAY_BUFFER, new Float32Array(vert2), gl.STREAM_DRAW);
    gl.vertexAttribPointer (pmeter.locVtx, 2, gl.FLOAT, false, 0, 0);
