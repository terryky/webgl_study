...
function on_mouse_down (event)
{
    ...
    s_event_log.innerHTML += "mouse_down: (" + s_mouse_pos.x + ", " + s_mouse_pos.y + ")" + "<br>";
...
function on_mouse_move (event)
{
    ...
    if (s_mouse_down)
    {
        ...
        s_event_log.innerHTML += "mouse_move: (" + s_mouse_pos.x + ", " + s_mouse_pos.y + ")" + "<br>";
        s_event_log.scrollTop = s_event_log.scrollHeight;
    }
}
...
function startWebGL()
{
    ...
    s_event_log   = document.getElementById('event_log');
    ...
    function render (now)
    {
        ...
        if (s_ongoing_touch.length > 0)
            dbgstr.draw_dbgstr_ex (gl, "TOUCH:" + s_ongoing_touch.length, win_w - 140, 22 * 4, 1, [1.0, 1.0, 1.0, 1.0], [0.0, 1.0, 1.0, 1.0]);
        else
            dbgstr.draw_dbgstr (gl, "TOUCH:0",  win_w - 140, 22 * 4);
